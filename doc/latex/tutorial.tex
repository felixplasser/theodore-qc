...
Format of coordinate file (coor_format):
Choice: g09 \comment{! format, as recongized by openbabel} %CHECK THIS%
\end{Verbatim}
\normalsize
...
-------------------------------------------------------
         C2 H3    0.12150   0.11214   0.23364   0.00936
         C2 H3    0.12150   0.11214   0.23364   0.00936
         C2 H2    0.13249   0.15121   0.28370  -0.01872
-------------------------------------------------------
...
------------------------------------------------------------------
I1.1-2      5.565  0.000  0.375  2.067  2.966  0.812  2.715  0.075
I2.1-1      6.530  1.254  0.865  2.122  2.897  0.617  2.861 -0.113
I2.1-2      6.772  0.006  0.432  2.162  2.837  0.897  1.833  0.108
\end{Verbatim}
\normalsize
...
\theo{} is able to decompose electron and hole populations of excited states Refs~\cite{Fragments}. For this example, we are going to use a small Ir complex with three bidentate ligands. First get the files from the \texttt{EXAMPLES} directory:\\
...
A more in depth analysis can be carried out using VMD. Run:\\
...
The results you get for the naphthalene molecule as outlined in this tutorial are shown below:

\greybox{You can also use \textsc{PyMOL} to visualise the conditional densities but note that you need to change the .cb file ending to .cube}
\clearpage
