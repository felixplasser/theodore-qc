...
\section{Hexatriene (\textsc{Columbus}) - Advanced fragment input and double excitations}
\label{sec:advinp}
...
\subsection{Automatic fragment generation using Avogadro}
In this part, method for automatic fragment generation is discussed.
This method relies on the \textsc{Avogadro} molecular structure editor.
...
This file can be opened with avogadro
